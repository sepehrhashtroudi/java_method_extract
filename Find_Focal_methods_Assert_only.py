    ...
    for (root,dirs,files) in os.walk(source_file_path, topdown=True):
        ...
        for file in files:
                            ...
                            if test.find(key)!=-1:
                                ...
                                for j,n in enumerate(context_copy):  #find the method name in the context and replace it with method body at the begining of the list
                                    if key+'(' in n:
                                        ...
                                        context_copy.insert(2,new_test)
                                        break
            ...
            #     print(sys.exc_info())
                    ...
                    print(root+"/"+file)
    with open("Evosuit_train_Assert.tests", "w") as Evosuit_train_tests, open("Evosuit_train_Assert.methods", "w") as Evosuit_train_methods , open("Evosuit_test_Assert.tests", "w") as Evosuit_test_tests, open("Evosuit_test_Assert.methods", "w") as Evosuit_test_methods:
