...
String SUSPICIOUS_COMMENT_WARNING=Optional[IRFactory.SUSPICIOUS_COMMENT_WARNING]
String TRAILING_COMMA_MESSAGE=Optional[ScriptRuntime.getMessage0("msg.extra.trailing.comma")]
String BAD_PROPERTY_MESSAGE=Optional[ScriptRuntime.getMessage0("msg.bad.prop")]
String MISSING_GT_MESSAGE=Optional["Bad type annotation. " + com.google.javascript.rhino.ScriptRuntime.getMessage0("msg.jsdoc.missing.gt")]
String MISPLACED_TYPE_ANNOTATION=Optional[IRFactory.MISPLACED_TYPE_ANNOTATION]
Config.LanguageMode mode
boolean isIdeMode=Optional[false]
