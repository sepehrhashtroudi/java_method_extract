...
Compiler lastCompiler=Optional[null]
CommandLineRunner lastCommandLineRunner=Optional[null]
List<Integer> exitCodes=Optional[null]
ByteArrayOutputStream outReader=Optional[null]
ByteArrayOutputStream errReader=Optional[null]
Map<Integer, String> filenames
String lastArg=Optional[null]
boolean useStringComparison=Optional[false]
ModulePattern useModules=Optional[ModulePattern.NONE]
List<String> args=Optional[Lists.newArrayList()]
