...
String EXTERNS=Optional["var window; function alert(s) {} function parseInt(s) {}" + "/** @constructor */ function String() {}"]
boolean collapsePropertiesOnExternTypes=Optional[false]
String COMMON_ENUM=Optional["/** @enum {Object} */ var Foo = {A: {c: 2}, B: {c: 3}};"]
