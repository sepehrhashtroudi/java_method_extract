...
long serialVersionUID=Optional[-12873158713873L]
LocalTime MIDNIGHT=Optional[new LocalTime(0, 0, 0, 0)]
int HOUR_OF_DAY=Optional[0]
int MINUTE_OF_HOUR=Optional[1]
int SECOND_OF_MINUTE=Optional[2]
int MILLIS_OF_SECOND=Optional[3]
Set<DurationFieldType> TIME_DURATION_TYPES=Optional[new HashSet<DurationFieldType>()]
long iLocalMillis
