...
long serialVersionUID=Optional[3633353405803318660L]
DateTimeFieldType[] FIELD_TYPES=Optional[new DateTimeFieldType[] { DateTimeFieldType.hourOfDay(), DateTimeFieldType.minuteOfHour(), DateTimeFieldType.secondOfMinute(), DateTimeFieldType.millisOfSecond() }]
TimeOfDay MIDNIGHT=Optional[new TimeOfDay(0, 0, 0, 0)]
int HOUR_OF_DAY=Optional[0]
int MINUTE_OF_HOUR=Optional[1]
int SECOND_OF_MINUTE=Optional[2]
int MILLIS_OF_SECOND=Optional[3]
