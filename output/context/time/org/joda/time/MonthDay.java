...
long serialVersionUID=Optional[2954560699050434609L]
DateTimeFieldType[] FIELD_TYPES=Optional[new DateTimeFieldType[] { DateTimeFieldType.monthOfYear(), DateTimeFieldType.dayOfMonth() }]
DateTimeFormatter PARSER=Optional[new DateTimeFormatterBuilder().appendOptional(ISODateTimeFormat.localDateParser().getParser()).appendOptional(DateTimeFormat.forPattern("--MM-dd").getParser()).toFormatter()]
int MONTH_OF_YEAR=Optional[0]
int DAY_OF_MONTH=Optional[1]
