...
ConcreteType NONE=Optional[new ConcreteNoneType()]
ConcreteType ALL=Optional[new ConcreteAll()]
List<ConcreteFunctionType> NO_FUNCTIONS=Optional[Lists.<ConcreteFunctionType>newArrayList()]
List<ConcreteInstanceType> NO_INSTANCES=Optional[Lists.<ConcreteInstanceType>newArrayList()]
List<StaticSlot<ConcreteType>> NO_SLOTS=Optional[Lists.<StaticSlot<ConcreteType>>newArrayList()]
