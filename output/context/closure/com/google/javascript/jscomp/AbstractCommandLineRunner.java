...
DiagnosticType OUTPUT_SAME_AS_INPUT_ERROR=Optional[DiagnosticType.error("JSC_OUTPUT_SAME_AS_INPUT_ERROR", "Bad output file (already listed as input file): {0}")]
...
String legacyOutputCharset
boolean testMode=Optional[false]
Supplier<List<SourceFile>> externsSupplierForTesting=Optional[null]
Supplier<List<SourceFile>> inputsSupplierForTesting=Optional[null]
Supplier<List<JSModule>> modulesSupplierForTesting=Optional[null]
Function<Integer, Boolean> exitCodeReceiverForTesting=Optional[null]
Map<String, String> rootRelativePathsMap=Optional[null]
Map<String, String> parsedModuleWrappers=Optional[null]
int NUM_RUNS_TO_DETERMINE_OPTIMAL_ORDER=Optional[100]
String OUTPUT_MARKER=Optional["%output%"]
String OUTPUT_MARKER_JS_STRING=Optional["%output|jsstring%"]
RunTimeStats runTimeStats=Optional[new RunTimeStats()]
