...
public int hashCode()
String NON_HALTING_ERROR_MSG=Optional["TightenTypes pass appears to be stuck in an infinite loop."]
AbstractCompiler compiler
Map<Node, ConcreteFunctionType> functionFromDeclaration=Optional[Maps.newHashMap()]
Map<FunctionType, ConcreteFunctionType> functionFromJSType=Optional[Maps.newIdentityHashMap()]
Map<ObjectType, ConcreteInstanceType> instanceFromJSType=Optional[Maps.newHashMap()]
Map<ConcreteJSTypePair, ConcreteType> typeIntersectionMemos=Optional[Maps.newHashMap()]
ConcreteScope topScope
Set<ConcreteType> allInstantiatedTypes=Optional[Sets.newHashSet()]
