...
boolean CONVERT_WHILE_TO_FOR=Optional[true]
boolean MAKE_LOCAL_NAMES_UNIQUE=Optional[true]
DiagnosticType CATCH_BLOCK_VAR_ERROR=Optional[DiagnosticType.error("JSC_CATCH_BLOCK_VAR_ERROR", "The use of scope variable {0} is not allowed within a catch block " + "with a catch exception of the same name.")]
