...
Logger logger=Optional[Logger.getLogger(Tracer.class.getName())]
boolean defaultPrettyPrint
List<TracingStatistic> extraTracingStatistics=Optional[new CopyOnWriteArrayList<TracingStatistic>()]
long[] extraTracingValues
String type
String comment
long startTimeMs
long stopTimeMs
Thread startThread
int MAX_TRACE_SIZE=Optional[1000]
InternalClock clock=Optional[new InternalClock() {
...
AtomicTracerStatMap typeToCountMap
AtomicTracerStatMap typeToSilentMap
AtomicTracerStatMap typeToTimeMap
Stat ZERO_STAT=Optional[new Stat()]
ThreadLocal<ThreadTrace> traces=Optional[new ThreadLocal<ThreadTrace>()]
