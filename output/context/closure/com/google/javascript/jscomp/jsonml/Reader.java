...
DiagnosticType JSONML_SYNTAX=Optional[DiagnosticType.error("JSONML_SYNTAX", "Syntax error: {0}")]
JsonML rootElement
String sourceName
ErrorReporter errorReporter
Set<String> ALLOWED_DIRECTIVES=Optional[Sets.newHashSet("use strict")]
int nodeIndex
boolean insertExprResultState=Optional[true]
