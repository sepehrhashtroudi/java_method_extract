...
Map<Node, Callsite> callsitesByNode
Map<Node, Function> functionsByNode
boolean computeBackwardGraph
boolean computeForwardGraph
boolean useNameReferenceGraph=Optional[false]
boolean alreadyRun=Optional[false]
String MAIN_FUNCTION_NAME=Optional["{main}"]
