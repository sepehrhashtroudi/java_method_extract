...
DiagnosticType INVALID_MODIFIES_ANNOTATION=Optional[DiagnosticType.error("JSC_INVALID_MODIFIES_ANNOTATION", "@modifies may only appear in externs files.")]
AbstractCompiler compiler
DefinitionProvider definitionProvider
Map<Node, FunctionInformation> functionSideEffectMap
List<Node> allFunctionCalls
Node externs
Node root
