...
public abstract ErrorManager getErrorManager()
 ...
 abstract void updateGlobalVarReferences(Map<Var, ReferenceCollection> refMapPatch, Node collectionRoot)
...
DiagnosticType READ_ERROR=Optional[DiagnosticType.error("JSC_READ_ERROR", "Cannot read: {0}")]
LifeCycleStage stage=Optional[LifeCycleStage.RAW]
