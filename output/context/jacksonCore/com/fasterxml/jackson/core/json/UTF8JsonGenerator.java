...
byte BYTE_u=Optional[(byte) 'u']
byte BYTE_0=Optional[(byte) '0']
byte BYTE_LBRACKET=Optional[(byte) '[']
byte BYTE_RBRACKET=Optional[(byte) ']']
byte BYTE_LCURLY=Optional[(byte) '{']
byte BYTE_RCURLY=Optional[(byte) '}']
byte BYTE_BACKSLASH=Optional[(byte) '\\']
byte BYTE_COMMA=Optional[(byte) ',']
byte BYTE_COLON=Optional[(byte) ':']
byte BYTE_QUOTE=Optional[(byte) '"']
...
int MAX_BYTES_TO_BUFFER=Optional[512]
byte[] HEX_CHARS=Optional[CharTypes.copyHexBytes()]
byte[] NULL_BYTES=Optional[{ 'n', 'u', 'l', 'l' }]
byte[] TRUE_BYTES=Optional[{ 't', 'r', 'u', 'e' }]
byte[] FALSE_BYTES=Optional[{ 'f', 'a', 'l', 's', 'e' }]
