...
int INT_SPACE=Optional[0x20]
long serialVersionUID=Optional[1L]
char PADDING_CHAR_NONE=Optional['\0']
int BASE64_VALUE_INVALID=Optional[-1]
int BASE64_VALUE_PADDING=Optional[-2]
int[] _asciiToBase64=Optional[new int[128]]
char[] _base64ToAsciiC=Optional[new char[64]]
byte[] _base64ToAsciiB=Optional[new byte[64]]
String _name
boolean _usesPadding
char _paddingChar
int _maxLineLength
