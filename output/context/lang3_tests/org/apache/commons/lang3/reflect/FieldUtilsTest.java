...
private List<T> asArrayList(T... values)
...
String S=Optional["s"]
String SS=Optional["ss"]
Integer I0=Optional[Integer.valueOf(0)]
Integer I1=Optional[Integer.valueOf(1)]
Double D0=Optional[Double.valueOf(0.0)]
Double D1=Optional[Double.valueOf(1.0)]
PublicChild publicChild
PubliclyShadowedChild publiclyShadowedChild
PrivatelyShadowedChild privatelyShadowedChild
Class<?> parentClass=Optional[PublicChild.class.getSuperclass()]
