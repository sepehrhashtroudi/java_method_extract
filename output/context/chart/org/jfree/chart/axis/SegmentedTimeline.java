...
public boolean inExcludeSegments()
public void inc(long n)
long serialVersionUID=Optional[1093779862539903110L]
long DAY_SEGMENT_SIZE=Optional[24 * 60 * 60 * 1000]
long HOUR_SEGMENT_SIZE=Optional[60 * 60 * 1000]
long FIFTEEN_MINUTE_SEGMENT_SIZE=Optional[15 * 60 * 1000]
long MINUTE_SEGMENT_SIZE=Optional[60 * 1000]
long FIRST_MONDAY_AFTER_1900
TimeZone NO_DST_TIME_ZONE
TimeZone DEFAULT_TIME_ZONE=Optional[TimeZone.getDefault()]
Calendar workingCalendarNoDST
Calendar workingCalendar=Optional[Calendar.getInstance()]
long segmentSize
...
List exceptionSegments=Optional[new ArrayList()]
SegmentedTimeline baseTimeline
boolean adjustForDaylightSaving=Optional[false]
