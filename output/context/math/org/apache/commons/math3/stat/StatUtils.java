...
UnivariateStatistic SUM=Optional[new Sum()]
UnivariateStatistic SUM_OF_SQUARES=Optional[new SumOfSquares()]
UnivariateStatistic PRODUCT=Optional[new Product()]
UnivariateStatistic SUM_OF_LOGS=Optional[new SumOfLogs()]
UnivariateStatistic MIN=Optional[new Min()]
UnivariateStatistic MAX=Optional[new Max()]
UnivariateStatistic MEAN=Optional[new Mean()]
Variance VARIANCE=Optional[new Variance()]
Percentile PERCENTILE=Optional[new Percentile()]
GeometricMean GEOMETRIC_MEAN=Optional[new GeometricMean()]
