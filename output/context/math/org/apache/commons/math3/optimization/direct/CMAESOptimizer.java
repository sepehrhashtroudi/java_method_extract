...
int DEFAULT_CHECKFEASABLECOUNT=Optional[0]
double DEFAULT_STOPFITNESS=Optional[0]
boolean DEFAULT_ISACTIVECMA=Optional[true]
int DEFAULT_MAXITERATIONS=Optional[30000]
int DEFAULT_DIAGONALONLY=Optional[0]
RandomGenerator DEFAULT_RANDOMGENERATOR=Optional[new MersenneTwister()]
int lambda
boolean isActiveCMA
int checkFeasableCount
double[] inputSigma
int dimension
int diagonalOnly=Optional[0]
boolean isMinimize=Optional[true]
boolean generateStatistics=Optional[false]
int maxIterations
double stopFitness
double stopTolUpX
double stopTolX
