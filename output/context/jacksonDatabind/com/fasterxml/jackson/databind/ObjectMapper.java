...
JavaType JSON_NODE_TYPE=Optional[SimpleType.constructUnsafe(JsonNode.class)]
ClassIntrospector DEFAULT_INTROSPECTOR=Optional[BasicClassIntrospector.instance]
AnnotationIntrospector DEFAULT_ANNOTATION_INTROSPECTOR=Optional[new JacksonAnnotationIntrospector()]
VisibilityChecker<?> STD_VISIBILITY_CHECKER=Optional[VisibilityChecker.Std.defaultInstance()]
PrettyPrinter _defaultPrettyPrinter=Optional[new DefaultPrettyPrinter()]
BaseSettings DEFAULT_BASE=Optional[new BaseSettings(DEFAULT_INTROSPECTOR, DEFAULT_ANNOTATION_INTROSPECTOR, STD_VISIBILITY_CHECKER, null, TypeFactory.defaultInstance(), null, StdDateFormat.instance, null, Locale.getDefault(), // TimeZone.getDefault()
TimeZone.getTimeZone("GMT"), // 2.1
...
HashMap<ClassKey, Class<?>> _mixInAnnotations=Optional[new HashMap<ClassKey, Class<?>>()]
...
ConcurrentHashMap<JavaType, JsonDeserializer<Object>> _rootDeserializers=Optional[new ConcurrentHashMap<JavaType, JsonDeserializer<Object>>(64, 0.6f, 2)]
