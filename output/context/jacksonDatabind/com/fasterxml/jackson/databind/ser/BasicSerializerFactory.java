...
HashMap<String, JsonSerializer<?>> _concrete=Optional[new HashMap<String, JsonSerializer<?>>()]
HashMap<String, Class<? extends JsonSerializer<?>>> _concreteLazy=Optional[new HashMap<String, Class<? extends JsonSerializer<?>>>()]
