...
Class<?> CLASS_OBJECT=Optional[Object.class]
Class<?> CLASS_STRING=Optional[String.class]
Class<?> CLASS_CHAR_BUFFER=Optional[CharSequence.class]
Class<?> CLASS_ITERABLE=Optional[Iterable.class]
HashMap<String, Class<? extends Map>> _mapFallbacks=Optional[new HashMap<String, Class<? extends Map>>()]
HashMap<String, Class<? extends Collection>> _collectionFallbacks=Optional[new HashMap<String, Class<? extends Collection>>()]
