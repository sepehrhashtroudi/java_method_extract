...
Token jj_lastpos
int jj_la
boolean lookingAhead=Optional[false]
boolean jj_semLA
int jj_gen
int[] jj_la1=Optional[new int[39]]
int[] jj_la1_0
int[] jj_la1_1
int[] jj_la1_2
JJCalls[] jj_2_rtns=Optional[new JJCalls[6]]
boolean jj_rescan=Optional[false]
int jj_gc=Optional[0]
java.util.Vector jj_expentries=Optional[new java.util.Vector()]
int[] jj_expentry
int jj_kind=Optional[-1]
int[] jj_lasttokens=Optional[new int[100]]
int jj_endpos
