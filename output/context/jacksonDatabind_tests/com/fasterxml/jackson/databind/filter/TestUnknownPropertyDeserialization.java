...
public void markUnknown(String unk)
public boolean handleUnknownProperty(DeserializationContext ctxt, JsonParser jp, JsonDeserializer<?> deserializer, Object bean, String propertyName) throws IOException, JsonProcessingException
public String c()
...
String JSON_UNKNOWN_FIELD=Optional["{ \"a\" : 1, \"foo\" : [ 1, 2, 3], \"b\" : -1 }"]
