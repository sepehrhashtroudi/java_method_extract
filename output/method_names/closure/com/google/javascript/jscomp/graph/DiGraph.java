...
public abstract List<DiGraphNode<N, E>> getDirectedPredNodes(DiGraphNode<N, E> n)
public abstract List<DiGraphNode<N, E>> getDirectedSuccNodes(DiGraphNode<N, E> n)
public abstract List<DiGraphNode<N, E>> getDirectedPredNodes(N nodeValue)
public abstract List<DiGraphNode<N, E>> getDirectedSuccNodes(N nodeValue)
...
public abstract List<DiGraphEdge<N, E>> getDirectedGraphEdges(N n1, N n2)
