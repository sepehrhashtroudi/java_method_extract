...
protected T readAndMapFromString(String input, Class<T> cls) throws IOException
protected T readAndMapFromString(ObjectMapper m, String input, Class<T> cls) throws IOException
