public CoreOperationSubtract(Expression arg1, Expression arg2) { [EOL]     super(new Expression[] { arg1, arg2 }); [EOL] } <line_num>: 30,32
...
protected int getPrecedence() { [EOL]     return 4; [EOL] } <line_num>: 40,42
