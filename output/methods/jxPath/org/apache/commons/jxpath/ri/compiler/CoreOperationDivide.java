public CoreOperationDivide(Expression arg1, Expression arg2) { [EOL]     super(new Expression[] { arg1, arg2 }); [EOL] } <line_num>: 30,32
...
public String getSymbol() { [EOL]     return "div"; [EOL] } <line_num>: 48,50
